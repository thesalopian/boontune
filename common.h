 ...
 */
static FILE* fopen(const char *filename, const char *instruction)
{
 ...
 */
static size_t fread(void* buffer, size_t sizeToRead, FILE* file)
{
 ...
 */
static size_t fwrite(const void* buffer, size_t sizeToWrite, FILE* file)
{
 ...
 */
static size_t loadFile(const char* fileName, void* buffer, size_t bufferSize)
{
 ...
 */
static void* mallocAndLoadFile(const char* fileName, size_t* bufferSize) {
    size_t const fileSize = fsize(fileName);
    *bufferSize = fileSize;
 ...
 */
static void saveFile(const char* fileName, const void* buff, size_t buffSize)
{
